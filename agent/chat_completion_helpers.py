...
def build_api_kwargs(agent, api_messages: list, tools_for_api: list | None = None) -> dict:
    ...
    # OmniRoute is a custom localhost proxy, so the built-in OpenCode profile
    # never attaches x-opencode-session. Go 400s without it; OmniRoute forwards
    # the header to the upstream hop.
